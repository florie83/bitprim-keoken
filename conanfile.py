...
class BitprimNodeConan(BitprimConanFile):
    ...
    url = "https://github.com/bitprim/bitprim-keoken"
    description = "Bitprim Keoken"
    ...
    exports_sources = "src/*", "CMakeLists.txt", "cmake/*", "bitprim-keokenConfig.cmake.in", "bitprimbuildinfo.cmake", "include/*", "test/*", "console/*"
    package_files = "build/lbitprim-keoken.a"
    ...
    def package_info(self):
        ...
        self.cpp_info.libs = ["bitprim-keoken"]
