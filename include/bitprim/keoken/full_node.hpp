 ...
 */
#ifndef BITPRIM_KEOKEN_FULL_NODE_HPP
#define BITPRIM_KEOKEN_FULL_NODE_HPP
...
public:
    ...
    virtual const keoken::settings& keoken_settings() const;
...
private:
    ...
    const keoken::settings& keoken_settings_;
